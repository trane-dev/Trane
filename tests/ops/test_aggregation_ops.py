...
def test_count_agg_op(df):
    ...
    assert op.generate_description() == "the number of records"
...
def test_sum_agg_op(df):
    ...
    assert op.generate_description() == "the total <col> in all related records"
...
def test_avg_agg_op(df):
    ...
    assert op.generate_description() == "the average <col> in all related records"
...
def test_max_agg_op(df):
    ...
    assert op.generate_description() == "the maximum <col> in all related records"
...
def test_min_agg_op(df):
    ...
    assert op.generate_description() == "the minimum <col> in all related records"
...
def test_majority_agg_op(df):
    ...
    output = op(df)
    assert output == str(1)
    assert op.generate_description() == "the majority <col> in all related records"
