...
def test_load_store():
    ...
    assert dataframes["orders"][0]["netamount"].dtype == "float64[pyarrow]"
    assert dataframes["orders"][0]["tax"].dtype == "float64[pyarrow]"
    assert dataframes["orders"][0]["totalamount"].dtype == "float64[pyarrow]"
    ...
    assert dataframes["products"][0]["price"].dtype == "float64[pyarrow]"
