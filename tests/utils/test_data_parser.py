...
group_csv_contents = [('employee', 'group'),
                      ('Bob', 'Accounting'),
                      ('Jake', 'Engineering'),
                      ('Lisa', 'Engineering'),
                      ('Sue', 'HR')]

hire_date_csv_contents = [('employee', 'hire_date'),
                          ('Bob', '2004'),
                          ('Jake', '2008'),
                          ('Lisa', '2012'),
                          ('Sue', '2014')]

skills_csv_contents = [('group', 'skills'),
                       ('Accounting', 'math'),
...
supervisor_csv_contents = [('group', 'supervisor'),
                           ('Accounting', 'Carly'),
                           ('Engineering', 'Guido'),
                           ('HR', 'Steve')]

csv_lists_to_write = [(group_csv_contents, 'group.csv'),
...
def test_denormalize():
    ...
    relationships = [('group.csv', 'employee', 'hire_date.csv', 'employee'),
                     ('supervisor.csv', 'group', 'group.csv', 'group'),
                     ('group.csv', 'group', 'skills.csv', 'group')]
    res = denormalize(relationships)

    expected = pd.DataFrame([('Accounting', 'Carly', 'Bob', 2004, 'math'),
