...
class Labeler():
    ...
    def execute(self, entity_to_data_and_cutoff_dict, json_prediction_problems_filename):
        ...
        dfs = []
        columns = [entity_id_column, 'problem_label_excluding_data_post_cutoff_time', 'problem_label_all_data', 'cutoff_time']
        for prediction_problem in prediction_problems:
            ...
            for entity in entity_to_data_and_cutoff_dict:
                ...
                df_pre_cutoff_time_result, df_all_data_result = prediction_problem.execute(entity_data, time_column, entity_cutoff)
                ...
                df_row = [entity, label_precutoff_time, label_postcutoff_time, entity_cutoff]
