...
def load_instacart():
    dataframes = {
        "orders": (pd.read_csv(generate_local_filepath("data/instacart/orders.csv")), "id"),
        "order_products": (pd.read_csv(generate_local_filepath("data/instacart/order_products.csv")), "id"),
        "products": (pd.read_csv(generate_local_filepath("data/instacart/products.csv")), "id"),
        "aisles": (pd.read_csv(generate_local_filepath("data/instacart/aisles.csv")), "id"),
        "departments": (pd.read_csv(generate_local_filepath("data/instacart/departments.csv")), "id"),
    }
