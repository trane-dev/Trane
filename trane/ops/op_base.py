...
class OpBase(object):
    ...
    def op_type_check(self, column_type):
        """
        ...
        """
        self.input_type = column_type

        for defined_input_type, defined_output_type in self.IOTYPES:
            if column_type == defined_input_type:
                self.output_type = defined_output_type
