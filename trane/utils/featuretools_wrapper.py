...
class FeaturetoolsWrapper(object):
    ...
    def __init__(self, df, entity_col, time_col, variable_types, name):
        ...
        self.es = self.es.add_dataframe(dataframe_name=name,
                                                dataframe=df,
                                                time_index=time_col,
                                                index="__id__",
                                                make_index=True
        ...
        self.es = self.es.add_dataframe(dataframe_name=entity_col,
                                                dataframe=entity_df,
                                                index=entity_col
                                                )
    ...
    def compute_features(self, df, cutoff_df, feature_window):
        feature_matrix, features = ft.dfs(target_dataframe_name=self.entity_col,
